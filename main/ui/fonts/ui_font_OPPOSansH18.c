 ...
 * Size: 18 px
 * Bpp: 1
 * Opts: --bpp 1 --size 18 --font C:/Users/luoyunxin/Desktop/clock/assets/fonts/OPPOSans-H.ttf -o C:/Users/luoyunxin/Desktop/clock/assets/fonts\ui_font_OPPOSansH18.c --format lvgl -r 0x20-0x7f --symbols 多云晴阴天大雨周一二三四五六日 --no-compress --no-prefilter
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 1634, .adv_w = 288, .box_w = 16, .box_h = 14, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 1662, .adv_w = 288, .box_w = 16, .box_h = 16, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 1694, .adv_w = 288, .box_w = 16, .box_h = 15, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 1724, .adv_w = 288, .box_w = 16, .box_h = 16, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 1756, .adv_w = 288, .box_w = 16, .box_h = 16, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 1788, .adv_w = 288, .box_w = 14, .box_h = 15, .ofs_x = 2, .ofs_y = -2},
    {.bitmap_index = 1815, .adv_w = 288, .box_w = 16, .box_h = 17, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 1849, .adv_w = 288, .box_w = 17, .box_h = 17, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 1886, .adv_w = 288, .box_w = 17, .box_h = 17, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 1923, .adv_w = 288, .box_w = 12, .box_h = 16, .ofs_x = 3, .ofs_y = -2},
    {.bitmap_index = 1947, .adv_w = 288, .box_w = 16, .box_h = 17, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 1981, .adv_w = 288, .box_w = 15, .box_h = 16, .ofs_x = 2, .ofs_y = -2},
    {.bitmap_index = 2011, .adv_w = 288, .box_w = 16, .box_h = 16, .ofs_x = 1, .ofs_y = -2}
};
...
static const uint16_t unicode_list_1[] = {
    0x0, 0x9, 0x8c, 0x91, 0x94, 0x36d, 0x668, 0x8db,
    0xb1a, 0xb27, 0xb29, 0x17e5, 0x1874, 0x4834, 0x48e8
};
...
static const lv_font_fmt_txt_cmap_t cmaps[] =
{
    ...
    {
        .range_start = 19968, .range_length = 18665, .glyph_id_start = 96,
