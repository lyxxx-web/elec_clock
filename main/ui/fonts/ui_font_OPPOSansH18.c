 ...
 * Size: 18 px
 * Bpp: 1
 * Opts: --bpp 1 --size 18 --font D:/square_projects/clock/assets/fonts/OPPOSans-H.ttf -o D:/square_projects/clock/assets/fonts\ui_font_OPPOSansH18.c --format lvgl -r 0x20-0x7f --symbols 多云晴阴雪天中小转大雨周一二三四五六日今功德 --no-compress --no-prefilter
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 1916, .adv_w = 288, .box_w = 16, .box_h = 17, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 1950, .adv_w = 288, .box_w = 17, .box_h = 17, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 1987, .adv_w = 288, .box_w = 17, .box_h = 17, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 2024, .adv_w = 288, .box_w = 17, .box_h = 16, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 2058, .adv_w = 288, .box_w = 17, .box_h = 17, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 2095, .adv_w = 288, .box_w = 12, .box_h = 16, .ofs_x = 3, .ofs_y = -2},
    {.bitmap_index = 2119, .adv_w = 288, .box_w = 16, .box_h = 17, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 2153, .adv_w = 288, .box_w = 16, .box_h = 18, .ofs_x = 1, .ofs_y = -3},
    {.bitmap_index = 2189, .adv_w = 288, .box_w = 15, .box_h = 16, .ofs_x = 2, .ofs_y = -2},
    {.bitmap_index = 2219, .adv_w = 288, .box_w = 16, .box_h = 16, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 2251, .adv_w = 288, .box_w = 15, .box_h = 16, .ofs_x = 1, .ofs_y = -2}
};
...
static const uint16_t unicode_list_1[] = {
    ...
    0x49f, 0x668, 0x8db, 0xb1a, 0xb27, 0xb29, 0xe0f, 0x11b7,
    0x17e5, 0x1874, 0x416c, 0x4834, 0x48e8, 0x48ea
};
