...
#define CONFIG_THORVG_THREAD_ENABLED 1
#define CONFIG_THORVG_LOTTIE_LOADER_SUPPORT 1
#define CONFIG_THORVG_TVG_LOADER_SUPPORT 1
#define CONFIG_THORVG_SVG_LOADER_SUPPORT 1
